...
class EvaluationDataPage(NamedTuple):
    ...
    def create_from_tensors_dqn(
        ...
        #print('----- Xiao 12/01/2019: evaluation_data_page.py line 245 optimal_q_values=', optimal_q_values.shape, optimal_q_values)        
        print('----- Xiao 12/01/2019: evaluation_data_page.py line 246 optimal_q_values max, min, mean:', optimal_q_values.max(), optimal_q_values.min(), optimal_q_values.mean())
