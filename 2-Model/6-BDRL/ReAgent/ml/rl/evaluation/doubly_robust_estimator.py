...
class DoublyRobustEstimator:
    ...
    def _get_importance_sampling_inputs(
        ...
        print('Xiao 11/30/2019: doubly_robust_estimator.py line 195: importance_weight=' ,importance_weights.shape, importance_weights)
        print('Xiao 12/01/2019: doubly_robust_estimator.py line 196: importance_weight max, min, mean:', importance_weights.max(), importance_weights.min(), importance_weights.mean())
    ...
    def _get_importance_sampling_estimates(
        ...
        print('Xiao 12/01/2019: doubly_robust_estimator.py line 210: isd.logged_rewards = ', isd.logged_rewards.shape, isd.logged_rewards)
        ...
        if logged_policy_score < 1e-6:
            ...
            print('Xiao 11/30/2019: doubly_robust_estimator.py line 221: logged_policy_score, normalizer =', logged_policy_score, normalizer)
        ...
        print('Xiao 11/30/2019: doubly_robust_estimator.py line 233: direct_method_values=' ,direct_method_values.shape, direct_method_values)
        print('Xiao 12/01/2019: doubly_robust_estimator.py line 235: direct_method_values max, min, mean:', direct_method_values.max(), direct_method_values.min(), direct_method_values.mean())
        direct_method_score = float(torch.mean(direct_method_values))
        print('Xiao 11/30/2019: doubly_robust_estimator.py line 238: direct_method_score, normalized =', direct_method_score, direct_method_score * normalizer)
        ...
        print('Xiao 12/01/2019: doubly_robust_estimator.py line 253: index', (doubly_robust == doubly_robust.max()).nonzero(), 'isd.importance_weight', isd.importance_weight[(doubly_robust == doubly_robust.max()).nonzero()],
         '\nisd.logged_rewards', isd.logged_rewards[(doubly_robust == doubly_robust.max()).nonzero()], '\nisd.model_rewards_for_logged_action', isd.model_rewards_for_logged_action[(doubly_robust == doubly_robust.max()).nonzero()],
          '\ndirect_method_values', direct_method_values[(doubly_robust == doubly_robust.max()).nonzero()] )
        # model_rewards_for_logged_action is N*1 of estimated rewards for target
        # policy
        print('Xiao 11/30/2019: doubly_robust_estimator.py line 255: doubly_robust=' ,doubly_robust.shape, doubly_robust)
        print('Xiao 12/01/2019: doubly_robust_estimator.py line 256: doubly_robust max, min, mean:', doubly_robust.max(), doubly_robust.min(), doubly_robust.mean())
        ips_score = float(torch.mean(ips))
        print('Xiao 11/30/2019: doubly_robust_estimator.py line 263: ips_score, normalized =', ips_score, ips_score * normalizer)
        ...
        print('Xiao 11/30/2019: doubly_robust_estimator.py line 271: dr_score, normalized =', dr_score, dr_score * normalizer)
