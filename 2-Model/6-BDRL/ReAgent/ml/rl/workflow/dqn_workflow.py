...
sys.path.append('/Users/tmjl/Documents/ReAgent')
...
def single_process_main(gpu_index, *args):
    ...
    params["rainbow"]["training_data_path"] = params["training_data_path"] # changed Nov. 2 2019, Yan
    ...
    try:
        cnn_parameters = from_json(params["cnn_parameters"], CNNParameters)
    except:
        cnn_parameters = None
    model_params = DiscreteActionModelParameters(
